...
function Package(deploymentConfig, parent, name, versionSpec, baseDir, production, sourcesCache) {
    ...
    this.source = Source.constructSource(baseDir, deploymentConfig.outputDir, name, versionSpec);
...
Package.prototype.resolveDependencies = function(callback) {
    ...
    slasp.sequence([
        ...
        function(callback) {
            self.bundleDependencies(resolvedDependencies, self.source.config.optionalDependencies, callback);
        },
